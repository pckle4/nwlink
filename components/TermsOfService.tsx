    ...
    <div className="w-full max-w-4xl mx-auto animate-fade-in pb-20 px-4">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-12 text-slate-600 dark:text-slate-300">
        ...
        <section>
            ...
            <p>
                NW Share does not offer cloud storage. Nowhile does not store or see any file, nothing. Files are streamed directly between devices. If you close your browser tab, the transfer session ends immediately. We cannot recover lost files or broken transfers.
            </p>
        </section>
        ...
        <section>
            ...
            <p className="mb-4">
                If you have any questions about these terms or need to reach us, please use the appropriate email address below. Nowhile does not store or see any file, nothing whatsoever. Our standard response time is <strong>48 hours</strong>.
            </p>
            <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-6 border border-slate-100 dark:border-slate-700">
                <ul className="space-y-3">
                    <li className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                        <strong className="text-slate-900 dark:text-white min-w-[140px]">General Help:</strong> 
                        <a href="mailto:help@nowhile.com" className="text-indigo-600 dark:text-indigo-400 font-medium hover:underline">help@nowhile.com</a>
                    </li>
                    <li className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                        <strong className="text-slate-900 dark:text-white min-w-[140px]">Other Inquiries:</strong> 
                        <a href="mailto:ansh@nowhile.com" className="text-indigo-600 dark:text-indigo-400 font-medium hover:underline">ansh@nowhile.com</a>
                    </li>
                    <li className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                        <strong className="text-slate-900 dark:text-white min-w-[140px]">Legal/Privacy:</strong> 
                        <a href="mailto:legal@nowhile.com" className="text-indigo-600 dark:text-indigo-400 font-medium hover:underline">legal@nowhile.com</a>
                    </li>
                </ul>
            </div>
        </section>
