    ...
    <div className="w-full max-w-4xl mx-auto animate-fade-in pb-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-700 shadow-xl shadow-slate-200/50 dark:shadow-none">
              ...
              <p className="text-slate-500 dark:text-slate-400">
                  Files are streamed directly from the sender to the receiver. Nowhile does not store or see any file, nothing. Once the browser tab is closed, the data is gone forever.
              </p>
          </div>
      </div>
      ...
      <div className="prose dark:prose-invert max-w-none space-y-12 text-slate-600 dark:text-slate-300">
        ...
        <section className="bg-indigo-50 dark:bg-indigo-900/10 p-8 rounded-3xl">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Contacting Us</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                Nowhile does not store or see any file, nothing whatsoever. If you have any questions or need to reach out, here is how you can contact us:
            </p>
            <ul className="text-sm space-y-2 text-slate-600 dark:text-slate-400 mb-4 marker:text-indigo-500 list-disc pl-5">
                <li><strong className="text-slate-900 dark:text-white">General Help & Support:</strong> <a href="mailto:help@nowhile.com" className="text-indigo-500 hover:underline">help@nowhile.com</a></li>
                <li><strong className="text-slate-900 dark:text-white">Escalations & Other Inquiries:</strong> <a href="mailto:ansh@nowhile.com" className="text-indigo-500 hover:underline">ansh@nowhile.com</a></li>
                <li><strong className="text-slate-900 dark:text-white">Legal & Privacy Issues:</strong> <a href="mailto:legal@nowhile.com" className="text-indigo-500 hover:underline">legal@nowhile.com</a></li>
            </ul>
            <p className="text-sm text-slate-600 dark:text-slate-400 font-medium pt-2 border-t border-indigo-100 dark:border-indigo-800/30">
                Our standard response time is <strong>48 hours</strong>.
            </p>
        </section>
      </div>
